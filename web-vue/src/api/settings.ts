...
export function normalizeSettings(raw: RawSettings | null | undefined): Settings {
  ...
  const normalized = {
    ...
    refresh_account_interval_minute: numberValue(source.refresh_account_interval_minute, 5, 0),
...
function toBackendSettings(settings: Settings): RawSettings {
  ...
  const payload: RawSettings = {
    ...
    refresh_account_interval_minute: numberValue(normalized.refresh_account_interval_minute, 5, 0),
